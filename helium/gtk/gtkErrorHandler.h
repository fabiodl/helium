#ifndef GTKEXCEPTIONHANDLER
#define GTKEXCEPTIONHANDLER
...
class GtkExceptionHandler:public helium::exc::ExceptionHandler{
 public:
...
public:
  ...
  template<typename C,typename R>
    sigc::bind_functor<-1, sigc::bound_mem_functor2<R,GtkExceptionHandler,C*,R (C::*)()>,C*, R (C::*)() >	
    wrap(C& c,R (C::*m)()){
    return sigc::bind<C*,R (C::*)()>( sigc::mem_fun(*this,&GtkExceptionHandler::handle<C,R>),&c,m);
  }


  template<typename C,typename R,typename P1>
    sigc::bind_functor<-1, sigc::bound_mem_functor3<R,GtkExceptionHandler,P1,C*,R (C::*)(P1)>,P1,C*, R (C::*)(P1) >	
    wrap(C& c,R (C::*m)(P1),P1 p1){
    return sigc::bind<P1,C*,R (C::*)(P1)>( sigc::mem_fun(*this,&GtkExceptionHandler::handle1<C,P1,R>),p1,&c,m);
  }

  template<typename C,typename R,typename P1,typename P2>
    sigc::bind_functor<-1, sigc::bound_mem_functor4<R,GtkExceptionHandler,P1,P2,C*,R (C::*)(P1,P2)>,P1,P2,C*, R (C::*)(P1,P2) >	
    wrap(C& c,R (C::*m)(P1,P2),P1 p1,P2 p2){
    return sigc::bind<P1,P2,C*,R (C::*)(P1,P2)>( sigc::mem_fun(*this,&GtkExceptionHandler::handle2<C,P1,P2,R>),p1,p2,&c,m);
  }

  
  template<typename C,typename R,typename P1>
    sigc::bind_functor<-1, sigc::bound_mem_functor3<R,GtkExceptionHandler,P1,C*,R (C::*)(P1)>,C*, R (C::*)(P1) >	
    wrap(C& c,R (C::*m)(P1)){
    return sigc::bind<C*,R (C::*)(P1)>( sigc::mem_fun(*this,&GtkExceptionHandler::handle1<C,P1,R>),&c,m);
  }

  template<typename C,typename R,typename P1,typename P2>
    sigc::bind_functor<-1, sigc::bound_mem_functor4<R,GtkExceptionHandler,P1,P2,C*,R (C::*)(P1,P2)>,C*, R (C::*)(P1,P2) >	
    wrap(C& c,R (C::*m)(P1,P2)){
    return sigc::bind<C*,R (C::*)(P1,P2)>( sigc::mem_fun(*this,&GtkExceptionHandler::handle2<C,P1,P2,R>),&c,m);
  }
  
  template<typename C,typename R,typename P1,typename P2>
  sigc::bind_functor<-1, sigc::bound_mem_functor4<R,GtkExceptionHandler,P1,P2,C*,R (C::*)(P1,P2)>,P2,C*,R (C::*)(P1,P2) >	
  wrap(C& c,R (C::*m)(P1,P2),P2 p2){
    return sigc::bind<P2,C*,R (C::*)(P1,P2)>( sigc::mem_fun(*this,&GtkExceptionHandler::handle2<C,P1,P2,R>),p2,&c,m);
  }

  
  template<typename C,typename R,typename P1,typename P2,typename P3>
    sigc::bind_functor<-1, sigc::bound_mem_functor5<R,GtkExceptionHandler,P1,P2,P3,C*,R (C::*)(P1,P2,P3)>,C*, R (C::*)(P1,P2,P3) >	
    wrap(C& c,R (C::*m)(P1,P2,P3)){
    return sigc::bind<C*,R (C::*)(P1,P2,P3)>( sigc::mem_fun(*this,&GtkExceptionHandler::handle3<C,P1,P2,P3,R>),&c,m);
  }

  template<typename C,typename R,typename P1,typename P2,typename P3,typename P4>
    sigc::bind_functor<-1, sigc::bound_mem_functor6<R,GtkExceptionHandler,P1,P2,P3,P4,C*,R (C::*)(P1,P2,P3,P4)>,C*, R (C::*)(P1,P2,P3,P4) >	
    wrap(C& c,R (C::*m)(P1,P2,P3,P4)){
    return sigc::bind<C*,R (C::*)(P1,P2,P3,P4)>( sigc::mem_fun(*this,&GtkExceptionHandler::handle4<C,P1,P2,P3,P4,R>),&c,m);
  }

  template<typename C,typename R,typename P1,typename P2,typename P3,typename P4,typename P5>
    sigc::bind_functor<-1, sigc::bound_mem_functor7<R,GtkExceptionHandler,P1,P2,P3,P4,P5,C*,R (C::*)(P1,P2,P3,P4,P5)>,C*, R (C::*)(P1,P2,P3,P4,P5) >	
    wrap(C& c,R (C::*m)(P1,P2,P3,P4,P5)){
    return sigc::bind<C*,R (C::*)(P1,P2,P3,P4,P5)>( sigc::mem_fun(*this,&GtkExceptionHandler::handle5<C,P1,P2,P3,P4,P5,R>),&c,m);
  }

  /*template<typename C,typename R,typename P1,typename P2,typename P3,typename P4>
    //sigc::mem_functor2<C*,R (C::*)() ,R,GtkExceptionHandler> 
    sigc::bind_functor<-1, sigc::bound_mem_functor2<R,GtkExceptionHandler,C*,R (C::*)(P1,P2,P3,P4)>,C*, R (C::*)(P1,P2,P3,P4) >	
    wrap(C& c,R (C::*m)(P1,P2,P3,P4)){
    return sigc::bind<C*,R (C::*)(P1,P2,P3,P4)>( sigc::mem_fun(*this,&GtkExceptionHandler::handle<C,R>),&c,m);
    }*/
